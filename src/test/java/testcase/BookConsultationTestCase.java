...
public class BookConsultationTestCase extends BaseClass {
    public LoginPage loginPage;
    public FindLawyerPage findLawyerPage;


   @Test
   public void bookConsultationTestCase() throws IOException{
       ...
       findLawyerPage.scheduleAndPayFlow("234566");
